...
class AVHanLayer(nn.Module):
    ...
    def forward(self, src_q, src_v, re_attention=False, src_mask=None, src_key_padding_mask=None):

        src_q = src_q.permute(1, 0, 2)
        src_v = src_v.permute(1, 0, 2)
        src1, cross_attention = self.cm_attn(src_q, src_v, src_v, attn_mask=src_mask, key_padding_mask=src_key_padding_mask)
        ...
        if re_attention is True:
            return src_q.permute(1, 0, 2), cross_attention
        else:
